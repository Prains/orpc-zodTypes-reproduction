...
export const PlanetGroupBySchema = z.object({
  where: PlanetWhereInputObjectSchema.optional(),
  orderBy: z
    .union([
      PlanetOrderByWithAggregationInputObjectSchema,
      PlanetOrderByWithAggregationInputObjectSchema.array(),
    ])
    .optional(),
  having: PlanetScalarWhereWithAggregatesInputObjectSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  by: z.array(PlanetScalarFieldEnumSchema),
});
