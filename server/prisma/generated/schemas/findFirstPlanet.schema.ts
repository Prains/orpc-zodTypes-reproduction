...
export const PlanetSelectSchema: z.ZodType<Prisma.PlanetSelect> = z
  .object({
...
export const PlanetSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const PlanetFindFirstSchema: z.ZodType<Prisma.PlanetFindFirstArgs> = z
  .object({
    select: PlanetSelectSchema.optional(),
    orderBy: z
      .union([
        PlanetOrderByWithRelationInputObjectSchema,
        PlanetOrderByWithRelationInputObjectSchema.array(),
      ])
      .optional(),
    where: PlanetWhereInputObjectSchema.optional(),
    cursor: PlanetWhereUniqueInputObjectSchema.optional(),
    take: z.number().optional(),
    skip: z.number().optional(),
    distinct: z
      .union([PlanetScalarFieldEnumSchema, PlanetScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export const PlanetFindFirstZodSchema = z
  .object({
    select: PlanetSelectSchema.optional(),
    orderBy: z
      .union([
