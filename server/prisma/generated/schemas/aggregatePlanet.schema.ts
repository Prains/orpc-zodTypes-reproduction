...
export const PlanetAggregateSchema = z.object({
  orderBy: z
    .union([
  ...
  _count: z
    .union([z.literal(true), PlanetCountAggregateInputObjectSchema])
    .optional(),
  _min: PlanetMinAggregateInputObjectSchema.optional(),
  _max: PlanetMaxAggregateInputObjectSchema.optional(),
});
